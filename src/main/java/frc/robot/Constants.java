...
public final class Constants {
  ...
  public static final class KrakenMotorConstants {
    public static final int kIntakeDviceId = 2;
    public static final int kFeederDeviceId = 3;
    public static final int kShooterLeftDeviceId = 4;
    public static final int kShooterRightDeviceId = 5;
    public static final int kIdexerDeviceID = 6;
    public static final int kAmpBackpackID = 7;
  }
